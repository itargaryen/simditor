...
(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define('simditor', ["jquery","simple-module","simple-hotkeys","simple-uploader","to-markdown","marked"], function ($, SimpleModule, simpleHotkeys, simpleUploader, toMarkdown, marked) {
      return (root['Simditor'] = factory($, SimpleModule, simpleHotkeys, simpleUploader, toMarkdown, marked));
    });
  } else if (typeof exports === 'object') {
    // Node. Does not work with strict CommonJS, but
    // only CommonJS-like environments that support module.exports,
    // like Node.
    module.exports = factory(require("jquery"),require("simple-module"),require("simple-hotkeys"),require("simple-uploader"),require("to-markdown"),require("marked"));
  } else {
    root['Simditor'] = factory(root["jQuery"],root["SimpleModule"],root["simple.hotkeys"],root["simple.uploader"],root["toMarkdown"],root["marked"]);
  }
}(this, function ($, SimpleModule, simpleHotkeys, simpleUploader, toMarkdown, marked) {

var AlignmentButton, BlockquoteButton, BoldButton, Button, Clipboard, CodeButton, CodePopover, ColorButton, FontScaleButton, Formatter, HrButton, ImageButton, ImagePopover, IndentButton, Indentation, InputManager, ItalicButton, Keystroke, LinkButton, LinkPopover, ListButton, Markdown, OrderListButton, OutdentButton, Popover, Selection, Simditor, StrikethroughButton, TableButton, TitleButton, Toolbar, UnderlineButton, UndoManager, UnorderListButton, Util,
...
Formatter = (function(superClass) {
  ...
  Formatter.prototype._init = function() {
    this.editor = this._module;
    this._allowedTags = $.merge(['br', 'span', 'a', 'img', 'b', 'strong', 'i', 'strike', 'u', 'font', 'p', 'ul', 'ol', 'li', 'blockquote', 'pre', 'code', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'hr'], this.opts.allowedTags);
...
Markdown = (function(superClass) {
  ...
  Markdown.prototype.icon = 'markdown';

  Markdown.prototype.needFocus = false;

  Markdown.prototype._init = function() {
    Markdown.__super__._init.call(this);
  ...
  Markdown.prototype.status = function() {};

  Markdown.prototype.command = function() {
  ...
  Markdown.prototype._initMarkdownValue = function() {
  ...
  Markdown.prototype._autosizeTextarea = function() {
  ...
  Markdown.prototype._convert = function() {
  ...
  Markdown.prototype._fileterUnsupportedTags = function() {
...
Simditor.Toolbar.addButton(Markdown);
